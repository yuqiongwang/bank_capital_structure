...
params.kappa_p = 0.02;     
params.pi_cap = 5;
params.underline_y = 1.02;  % intervention threshold
...
n_paths = 5000;% MC number for the probability
dt = 0.05;
mc_seed = 20240517;   
%% grid
n_a1 = length(a1_grid);
...
for i1 = 1:n_a1
    for i2 = 1:n_a2
        for i3 = 1:n_a3
            ...
            fprintf('[%3d/%3d] a1=%.3f, a2=%.3f, a3=%.3f ... ', ...
                idx, n_total, params.a1, params.a2, params.a3);

            % silently enter the Pareto frontier.
            ...
            try
                ...
                rng(mc_seed);   % CRN across triples
